...
interface ChineseCharacterEntry {
  id: string;
  traditional: string;
  simplified?: string;
  pinyin?: string[];
...
interface ChineseCharacterCardProps {
  entry: ChineseCharacterEntry;
  isExactMatch?: boolean;
}

export function ChineseCharacterCard({ entry, isExactMatch = false }: ChineseCharacterCardProps) {
  return (
    <Card className="w-full">
      ...
      <CardContent className="pt-2 pb-2">
        <div className="space-y-3">
          ...
          {/* Additional info */}
          {(entry.strokeCount || entry.hskLevel) && (

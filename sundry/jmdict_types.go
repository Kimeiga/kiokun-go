...
const (
	Explanation GlossType = "explanation"
	Figurative  GlossType = "figurative"
	Literal     GlossType = "literal"
	Trademark   GlossType = "trademark"
)
